    ...
    <div class="card-body py-5">
        ...
        <div class="row g-5 g-xl-8">
            <div class="col-xl-3">
                ...
                <a href="<?php echo site_url('rfq/rfq_goods'); ?>" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="<?php echo site_url('confirmation/con_price'); ?>" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
        ...
        <div class="row g-5 g-xl-8">
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="<?php echo site_url('negotiation/rfq_goods'); ?>" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
                        <!--begin::Svg Icon | path: icons/duotone/Shopping/Chart-pie.svg-->
                        <span class="svg-icon svg-icon-dark svg-icon-3x ms-n1">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-inverse-success fw-bolder fs-2 mb-2 mt-5" id="c_nego_goods"></div>
...
<!-- <script src="<?php //echo base_url();
                    ?>assets/js/custom/widgets.js"></script> -->
<script>
    "use strict";
