...
<div class="card shadow-sm">
    ...
    <div class="card-body py-5">
        <div class="w-lg-500px bg-body rounded shadow-sm p-5 p-lg-10 mx-auto">
            <!--begin::Form-->
            <form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" action="<?php echo site_url('users/do_change'); ?>">
                <!--begin::Heading-->
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if(obj.code == 0) {
                                            ...
                                            .then(function (t) {
                                                t.isConfirmed && (document.location = '<?php echo site_url('users/change_password'); ?>');
                                            });
                                        } else {
                                            setTimeout(function () {
                                                s.removeAttribute("data-kt-indicator"),
