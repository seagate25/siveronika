...
<script src="<?php echo base_url();?>/assets/js/custom/account/settings/signin-methods.js"></script>
<script src="<?php echo base_url();?>/assets/js/custom/account/settings/profile-details.js"></script>
<!-- <script src="<?php echo base_url();?>/assets/js/custom/account/settings/deactivate-account.js"></script> -->
<script src="<?php echo base_url();?>/assets/js/custom/modals/two-factor-authentication.js"></script>
