...
<div class="card shadow-sm">
    ...
    <form id="form_verification_new" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" enctype="multipart/form-data" action="<?php echo site_url('verification/save_item'); ?>">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select class="form-select form-select-solid" name="m_bidang" id="m_bidang" disabled="true">
                            ...
                            ?>
                            <option value="<?=$field->bidang_id;?>" <?=($verif_data->bidang_code == $field->bidang_code) ? 'selected' : ''?>>[<?=$field->bidang_code;?>] <?=$field->bidang_name;?></option>
                            <?php
                                }
                            ?>
                        </select>
