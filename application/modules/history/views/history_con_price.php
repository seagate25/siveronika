                ...
                <div class="modal-body py-4 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_confirmation_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_confirmation_header" data-kt-scroll-wrappers="#kt_modal_confirmation_scroll" data-kt-scroll-offset="300px" style="max-height: 144px;">
                                ...
                                <div class="col-lg-7 fv-row fv-plugins-icon-container">
                                    <div class="align-items-end mt-3">
                                        ...
                                        <label class="form-check form-check-inline form-check-solid me-5">
                                            <input class="form-check-input" name="repeat_order" disabled type="radio" value="1">
                                            <span class="fw-bold ps-2 fs-6">Ya</span>
                                        </label>
                                        <!--end::Option-->
                                        <!--begin::Option-->
                                        <label class="form-check form-check-inline form-check-solid">
                                            <input class="form-check-input" name="repeat_order" disabled type="radio" value="0">
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="number" name="available_total" class="form-control" placeholder="Jumlah Tersedia" readonly="true">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="number" name="indent_day" class="form-control" placeholder="Lama Indent (Hari)" readonly="true">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                        </div>
        ...
        return {
            init: function() {
                e = $("#kt_datatable_confirmation_price").DataTable({
                        ...
                        ajax: {
                            type: "POST",
                            url: "<?php echo site_url('history/con_price'); ?>"
                        },
                        columns: [{
                                data: 'number',
