            ...
            <tbody class="text-gray-600 fw-bold">
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-icon btn-sm btn-success me-2 mb-2" data-bs-toggle="modal" data-bs-target="#kt_modal_detail_rfq_goods">
...
<div class="modal fade" tabindex="-1" id="kt_modal_detail_rfq_goods" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="min-width: 990px;">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white">Detail RFQ Barang</h5>
            ...
            <div class="modal-footer flex-center">
                <!--begin::Button-->
                <button type="button" id="kt_modal_detail_rfq_goods_cancel" data-bs-dismiss="modal" aria-label="Close" class="btn btn-danger me-3">Tutup</button>
                <!--end::Button-->
                <!--begin::Button-->
